...
from model.graphformer import GCNClassifier
...
def unpack_batch(batch, cuda):
    ...
    return inputs, labels, tokens, head, first_pos, second_pos, cross, lens
...
class GCNTrainer(Trainer):
    ...
    def update(self, batch):
        inputs, labels, tokens, head, first_pos, second_pos, cross, lens = unpack_batch(batch, self.opt['cuda'])
