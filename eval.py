...
def eval(is_balanced):

    parser = argparse.ArgumentParser()
    parser.add_argument('--model_dir', default='saved_models/00', type=str, help='Directory of the model.')
    ...
    # load data
    if is_balanced:
        balanced.balanced_test_file()
    data_file = opt['data_dir'] + '/output.json'
