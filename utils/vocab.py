...
class Vocab(object):
    def __init__(self, filename, opt, load=False, word_counter=None, threshold=0):
        self.opt = opt
        self.context_emb = opt['context_emb']
        if load:
    ...
    def save(self, filename):
        ...
        with open(filename, 'wb') as outfile:
            ...
            if self.context_emb != 'bert':
                ...
                pickle.dump(self.word2id, outfile)
        return
